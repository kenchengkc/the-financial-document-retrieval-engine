...
def _run(command: list[str]) -> int:
    ...
    # Inherit stdout/stderr so long-running indexing emits progress immediately.
    # Capturing the complete child output hid progress and discarded it entirely
    # when the Actions runner was terminated during the embedding stage.
