...
def test_multi_metric_growth_requires_two_periods_per_metric() -> None:
    candidate = RetrievalCandidate(
        chunk_id=1,
        text="Apple reported revenue and net income results for the fiscal year.",
        metadata={"ticker": "AAPL", "element_type": "text"},
...
def test_multi_metric_growth_passes_with_two_periods_per_metric() -> None:
    candidate = RetrievalCandidate(
        chunk_id=1,
        text="Apple reported revenue and net income growth for the fiscal year.",
        metadata={"ticker": "AAPL", "element_type": "text"},
        rerank_score=0.9,
    )
    state: AnswerWorkflowState = {
